...
\begin{document}
	\begin{tikzpicture}[
		...
		\node [c,above=of kinetic,xshift=5em] (kinetic comment) {non-rel. Schr̦dinger equation\\or relativistic Dirac equation};
